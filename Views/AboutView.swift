        ...
        NavigationStack {
            List {
                Section {
                    ...
                    Text("チャンネルの投稿動画を公開日順（古い順）に整理し、順番に視聴しやすくする補助アプリです。")
                        .font(.subheadline)
                ...
                Section("重要な注意事項") {
                    ...
                    disclaimerRow("動画の再生には YouTube 公式の埋め込みプレイヤー（IFrame Player）を使用しています。")
                    disclaimerRow("動画のダウンロード、広告の回避、バックグラウンド再生は行いません。")
                }
